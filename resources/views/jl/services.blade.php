                                                ...
                                                <div class="iq-client white-bg">
                                                    <div class="client-img">
                                                        <img alt="#" class="img-fluid"
                                                             src="http://via.placeholder.com/83x83">
                                                    </div>
                                                    <div class="client-info">
                                                        ...
                                                        <p>Lorem ipsum madolor sit amet, consectetur adipisicing elit,
                                                            sed do eiusmod tempor coli incididunt ut labore.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="item">
                            ...
                            <div class="clients iq-pall-40 iq-mt-40">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-md-12">
                                        ...
                                        <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="true"
                                             data-dots="false" data-items="5" data-items-laptop="5" data-items-tab="4"
                                             data-items-mobile="3" data-items-mobile-sm="1" data-margin="30">
                                            <div class="item"><img class="img-responsive center-block"
                                                                   src="http://via.placeholder.com/300x100" alt="#">
                                            </div>
                                            <div class="item"><img class="img-responsive center-block"
                                                                   src="http://via.placeholder.com/300x100" alt="#">
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                                                   role="tab" aria-controls="home" aria-expanded="true"><i
                                                            class="ti-star"></i>Creative Idea</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile"
                                                   role="tab" aria-controls="profile"><i class="ti-ruler-pencil"></i>PSD
                                                    Design</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="about-tab" data-toggle="tab" href="#about"
                                                   role="tab" aria-controls="about"> <i class="ti-layout"></i>Web Design</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tabs-tab" data-toggle="tab" href="#tabs"
                                                   role="tab" aria-controls="tabs"><i class="ti-headphone-alt"></i>24/7
                                                    Support</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <img src="http://via.placeholder.com/800x560" class="img-fluid"
                                                             alt="#">
                                                    </div>
                                                    <div class="col-lg-9">
                            ...
                            <div class="iq-counter-box iq-pall-20">
                                <div class="row">
                                    <div class="col-md-3 text-center">
                                        <div class="counter"><i class="ti-folder iq-font-purple" aria-hidden="true"></i>
                                            <span class="timer iq-tw-6 iq-font-black" data-to="1540" data-speed="10000">1540</span>
                                            <label>Project</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 text-center">
                                        <div class="counter re-mt30"><i class="ti-medall iq-font-purple"
                                                                        aria-hidden="true"></i> <span
                                                    class="timer iq-tw-6 iq-font-black" data-to="2530"
                                                    data-speed="10000">2530</span>
                                            <label>Awards</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 text-center">
                                        <div class="counter re-mt30"><i class="ti-face-smile iq-font-purple"
                                                                        aria-hidden="true"></i> <span
                                                    class="timer iq-tw-6 iq-font-black" data-to="8120"
                                                    data-speed="10000">8120</span>
                                            <label>Happy Clients</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 text-center">
                                        <div class="counter re-mt30"><i class="ti-cup iq-font-purple"
                                                                        aria-hidden="true"></i> <span
                                                    class="timer iq-tw-6 iq-font-black" data-to="1620"
