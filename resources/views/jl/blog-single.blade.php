                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="main-title iq-mb-20">
                                        <small>MY LATEST BLOG</small>
                                        <h1 class="display-4 iq-tw-8 iq-font-purple">Blog Single</h1>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="iq-blog-box">
                                        <div class="iq-blog-image clearfix">
                                            <img class="img-fluid" src="http://via.placeholder.com/800x560" alt="#">
                                        </div>
                                        <div class="iq-blog-detail">
                                            ...
                                            <pre class="iq-pall-20 alert alert-dark iq-mtb-30">&lt;p&gt;Text here...&lt;/p&gt;</pre>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                                            ...
                                            <div class="media purple-bg iq-font-white iq-pall-30">
                                                <img alt="#" class="img-fluid mr-3" src="http://via.placeholder.com/84x84">
                                                <div class="media-body">
                                                    <h5 class="mt-0 iq-font-white">Rinku Kevin</h5> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                                </div>
                                            </div>
                                            <div id="comments" class="iq-mt-30">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="iq-comment-metadata"><a href="#"><i class="fa fa-calendar"></i>
                                                            ...
                                                            </a></div><a href="#" class="reply button">Reply</a>
