                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="main-title iq-mb-20">
                                        ...
                                        <h1 class="display-4 iq-tw-8 iq-font-purple">Blog Sidebar</h1>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="iq-blog-box">
                                        ...
                                        <div class="iq-blog-detail">
                                            ...
                                            <div class="blog-button">
                                                <a href="#" class="pull-left iq-tw-6 iq-user"><i class="fa fa-user-circle" aria-hidden="true"></i> Jenny Jones</a>
                                    ...
                                    <div class="iq-post-sidebar">
                                        ...
                                        <div class="iq-sidebar-widget">
                                            ...
                                            <div class="iq-recent-post media">
                                                <div class="media-left"> <a href="#"><img alt="" class="media-object" src="http://via.placeholder.com/70x60" style="width:70px; height:60px;"></a> </div>
